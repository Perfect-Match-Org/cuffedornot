...
function HowItWorksSteps() {
    ...
    return (
        <section ref={ref} className="bg-white px-6 py-14 border-b border-pmblue2-500">
            <div className="max-w-3xl mx-auto">
                <h2
                    className={`font-dela-gothic text-pmblue2-800 text-2xl text-center mb-10 transition-all duration-700 ease-out ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                    {steps.map((step, i) => (
                        <div
                            key={step.num}
                            className={`flex flex-col items-center gap-3 rounded-2xl border-2 border-pmblue2-500 bg-white p-6 shadow-[3px_3px_0px_0px_rgba(36,67,141,1)] transition-all duration-700 ease-out hover:-translate-y-1 hover:shadow-[5px_5px_0px_0px_rgba(36,67,141,1)] ${
...
export default function Home() {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative max-w-2xl mx-auto">
                    <div className="relative inline-block w-full">
                        <span className="absolute -top-8 left-4 md:-top-12 md:-left-8 text-4xl sm:text-6xl animate-pulse" aria-hidden="true">🎶</span>
                        <span className="absolute top-[40%] -right-4 md:-right-12 text-4xl sm:text-6xl animate-bounce" style={{ animationDelay: '0.2s' }} aria-hidden="true">💖</span>
                        <span className="absolute -bottom-2 md:-bottom-6 left-[8%] text-3xl sm:text-5xl animate-[bounce_2s_infinite]" style={{ animationDelay: '0.5s' }} aria-hidden="true">👀</span>
                        <h1 className="font-dela-gothic text-5xl sm:text-7xl lg:text-8xl text-pmblue2-800 leading-[0.95] mb-5 relative z-10 w-full text-center">
                            Cuffed
                            <br />
            ...
            <section className="bg-white px-6 py-8 border-b border-pmblue2-500 animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
            ...
            {/* ── Submit / MainFlow ── */}
            <section id="submit" className="bg-white px-6 py-12 animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s' }}>
                <div className="max-w-lg mx-auto">
                    {status === 'loading' ? (
            ...
            <section className="bg-pmpink2-500 border-t border-pmblue2-500 px-6 py-12">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="font-work-sans text-pmblue-500 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
                        CuffedOrNot is a special collaboration between Cornell PerfectMatch and{' '}
                        <a
            ...
            <footer className="bg-white border-t border-pmblue2-500 px-6 py-6 text-center space-y-2">
                <p className="font-work-sans text-xs text-gray-400">
                    &copy; Cornell PerfectMatch 2026 x &copy; Unserious Ventures 2026
                </p>
                <p className="font-work-sans text-xs text-gray-400">
